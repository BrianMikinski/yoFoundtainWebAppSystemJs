...
import {Todo} from '../todos/todos.ts';
...
describe('Header component', () => {
  ...
  it('should get the todos binded to the component', inject(($rootScope: ng.IRootScopeService, $compile: ng.ICompileService, $componentController) => {
